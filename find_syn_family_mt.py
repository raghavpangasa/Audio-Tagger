...
#print(df)
  df['instrument'] = z
#print(df)
  centroid = pd.DataFrame(pd.read_csv('/Users/somyagoel/Flask/basic_app/centroids/synthetic_clust.csv',low_memory=False))
  ...
  #    print("fam is ",fam)
      ...
      #  'instrument2': ['non_sustained','String','brass','woodwind']}
       # 'instrument2': ['bass_acoustic', 'brass_acoustic', 'flute_acoustic' , 'guitar_acoustic', 'keyboard_acoustic', 'mallet_acoustic', 'organ_acoustic', 'reed_acoustic', 'string_acoustic' ]}
          'instrument2': ['reed','bass_keyboard','guitar','mallet']}
