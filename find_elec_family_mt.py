...
def find_family_type_elec(arg1) :

#  dataset = pd.DataFrame(pd.read_csv('/Users/somyagoel/nsynth_add_labels/test/test_st/string_acoustic_080-033-075.wav_st.csv',low_memory=False))
...
#print(df)
  df['instrument'] = z
#print(df)
  centroid = pd.DataFrame(pd.read_csv('/Users/somyagoel/Flask/basic_app/centroids/electronic_clust.csv',low_memory=False))
   ...
   #   print("fam is ",fam)
      ...
      #  'instrument2': ['non_sustained','String','brass','woodwind']}
       # 'instrument2': ['bass_acoustic', 'brass_acoustic', 'flute_acoustic' , 'guitar_acoustic', 'keyboard_acoustic', 'mallet_acoustic', 'organ_acoustic', 'reed_acoustic', 'string_acoustic' ]}
          'instrument2': ['key_guitar_mallet','bass','brass_reed_string','flute_organ']}
